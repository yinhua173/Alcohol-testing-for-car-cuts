...
void display_4data(unsigned long Date1) {
    u8 wan, qian, bai, shi, ge;
    wan = Date1 / 10000 + 48;
    qian = Date1 % 10000 / 1000 + 48;
    bai = Date1 % 1000 / 100 + 48; // 计算shi
    shi = Date1 % 100 / 10 + 48;   // 计算ge
    ge = Date1 % 10 + 48;

    OLED_ShowChar(40, 48, wan, 16, 1); // 显示个位
    OLED_ShowChar(48, 48, '.', 16, 1);
    OLED_ShowChar(56, 48, qian, 16, 1); // 显示
    OLED_ShowChar(64, 48, bai, 16, 1);  // 显示
    OLED_ShowChar(72, 48, shi, 16, 1);  // 显示
    OLED_ShowChar(80, 48, ge, 16, 1);   // 显示
}
